...
class Biblioteca():
    ...
    def registrar_livro(self, titulo, ano_de_publicacao, isnb, disponibilidade=True):
        ...
        if self.verificar_livro(isnb):
            ...
            return
        livro = livro.Livro(titulo=titulo, ano_de_publicacao=ano_de_publicacao, isnb=isnb, disponibilidade=disponibilidade)
        livro.alterar_titulo(titulo)
        livro.alterar_ano_de_publicacao(ano_de_publicacao)
        livro.alterar_isnb(isnb)
